...
/*  This release is dated 16 February 2006 (with corrections in the          */
...
__device__ static void error(int flag)
...
__device__ int time_3d(float *HS, float *T, int NX, int NY, int NZ,
...
__device__ static int pre_init(void)
...
__device__ static int init_point(void)
...
/* end 261205[1] */
        if(SMALLTALK) printf("\nPoint source at [%g,%g,%g]; Nearest node [%d,%d,%d].",fxs,fys,fzs,xs,ys,zs);
    }
    hs0=hs[xsc][ysc][zsc];
...
__device__ static void init_nearest(void)
...
__device__ static void init_cell(float vx, float vy, float vz, int xl, int yl, int zl)
...
__device__ static float init_cellh(float vh, float vv, float hsc, float hsn)
...
__device__ static int recursive_init(void)
...
__device__ static int propagate_point(int start)
...
__device__ static void free_ptrs(int max_x)
...
__device__ static float exact_delay(float vx, float vy, float vz, int xm, int ym, int zm)
...
__device__ static int t_1d(int x, int y, int z,
...
__device__ static int diff_2d(int x, int y, int z, float t0, float hs0, float hs1)
...
__device__ static int point_diff(int x, int y, int z, float t0, float hs0)
...
__device__ static int t_2d(int x, int y, int z, float t0, float t1, float hs0, float hs1)
...
__device__ static int edge_diff(int x, int y, int z, float t0, float t1, float hs0)
...
__device__ static int t_3d_(int x, int y, int z, float t0, float tl, float tr, float td,
...
__device__ static int t_3d_part1(int x, int y, int z,
...
__device__ static int x_side(int y_begin, int y_end, int z_begin, int z_end,
                  int x, int future)
...
__device__ static int scan_x_bb(int y_begin, int y_start, int z_begin, int z_start,
                     int x0, int x, int x_s)
...
__device__ static int scan_x_fb(int y_start, int y_end, int z_begin, int z_start,
                     int x0, int x, int x_s)
...
__device__ static int y_side(int x_begin, int x_end, int z_begin, int z_end,
                  int y, int future)
...
__device__ static int scan_y_ff(int x_start, int x_end, int z_start, int z_end,
...
__device__ static int scan_y_bf(int x_begin, int x_start, int z_start, int z_end,
                     int y0, int y, int y_s)
...
__device__ static int scan_y_bb(int x_begin, int x_start, int z_begin, int z_start,
                     int y0, int y, int y_s)
...
__device__ static int scan_y_fb(int x_start, int x_end, int z_begin, int z_start,
                     int y0, int y, int y_s)
...
__device__ static int z_side(int x_begin, int x_end, int y_begin, int y_end,
                  int z, int future)
...
__device__ static int scan_z_ff(int x_start, int x_end, int y_start, int y_end,
...
__device__ static int scan_z_bf(int x_begin, int x_start, int y_start, int y_end,
                     int z0, int z, int z_s)
...
__device__ static int scan_z_bb(int x_begin, int x_start, int y_begin, int y_start,
                     int z0, int z, int z_s)
...
__device__ static int scan_z_fb(int x_start, int x_end, int y_begin, int y_start,
                     int z0, int z, int z_s)
...
__global__ void Podvin3D(float *HS, float *T, int NX, int NY, int NZ,
    float XS, float YS, float ZS, float HS_EPS_INIT, int MSG)
  {
