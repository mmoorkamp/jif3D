    ...
    BOOST_AUTO_TEST_CASE (X3D_Titan_deriv_test)
      {
        ...
        jif3D::WriteTitanDataToNetCDF("gra1dtitan.nc", Freq, TrueModel.GetMeasPosX(),
            TrueModel.GetMeasPosY(), TrueModel.GetMeasPosZ(), TrueModel.GetExIndices(),
            TrueModel.GetEyIndices(), TrueModel.GetHxIndices(), Observed);
        std::cout << "ExIndices: ";
        std::copy(TrueModel.GetExIndices().begin(), TrueModel.GetExIndices().end(),
            std::ostream_iterator<double>(std::cout, " "));
        std::cout << std::endl;

        std::cout << "EyIndices: ";
        std::copy(TrueModel.GetEyIndices().begin(), TrueModel.GetEyIndices().end(),
            std::ostream_iterator<double>(std::cout, " "));
        std::cout << std::endl;

        std::cout << "HIndices: ";
        std::copy(TrueModel.GetHxIndices().begin(), TrueModel.GetHxIndices().end(),
            std::ostream_iterator<double>(std::cout, " "));
        std::cout << std::endl;
