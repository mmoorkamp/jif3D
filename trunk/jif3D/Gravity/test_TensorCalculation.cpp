...
BOOST_AUTO_TEST_CASE(tensor_poisson_test)
  {
    ...
    jif3D::ThreeDModelBase::t3DModelDim XCD(nhorcells, 10.0), YCD(nhorcells, 10.0), ZCD(
        nzcells, 10.0);
...
BOOST_AUTO_TEST_CASE (lqderivative_test)
  {
    ...
    jif3D::rvec Deriv(TensorCalculator->LQDerivative(GravityTest, TensorData, Misfit));
    ...
    jif3D::rvec Deriv2(TensorCalculator->LQDerivative(GravityTest, TensorData, Misfit));
