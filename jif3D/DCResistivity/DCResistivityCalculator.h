...
namespace jif3D
  {
    ...
    private:
      ...
      void ModelToStruct(const ThreeDDCResistivityModel &Model, const jif3D::DCResistivityData &Data, jif3D::GEOMETRY_RES &geo,
                jif3D::GRID_STRUCT_RES &grid);
    ...
    public:
       ...
       */
      rvec Calculate(const ThreeDDCResistivityModel &Model, const DCResistivityData &Data);
       ...
       */
      rvec LQDerivative(const ThreeDDCResistivityModel &Model, const DCResistivityData &Data, const rvec &Misfit);
      };
  /* @} */
  }
