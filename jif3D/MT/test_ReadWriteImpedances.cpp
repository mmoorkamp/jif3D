...
void GenerateData(std::vector<double> &Frequencies, std::vector<double> &XCoord,
    ...
    std::vector<double> &Impedances, std::vector<double> &Error, std::vector<double> &C,
    size_t nstat = 7)
  {
...
BOOST_AUTO_TEST_CASE (read_write_mtt_test)
  {
    ...
    jif3D::WriteImpedancesToMtt(filename, Frequencies, Impedances, Error, Tipper, TipErr);
