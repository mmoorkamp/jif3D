...
int main(int argc, char *argv[])
{
	...
	desc.add_options()("help", "produce help message")("threads",
			po::value<int>(), "The number of openmp threads")("x3dname",
			po::value(&X3DName)->default_value("x3d"),
			"The name of the executable for x3d")("debug",
			"Show debugging output.")("tempdir", po::value<std::string>(),
	...
	for (size_t i = 0; i <= nmeasx; ++i)
	{
		...
		{
			MTModel.AddMeasurementPoint(minx + i * deltax, miny + j * deltay,
					z);
		}
	}
